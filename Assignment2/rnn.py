...
class RNN(nn.Module):
    ...
    def forward(self, inputs):
        ...
        h0 = torch.zeros(self.numOfLayer, inputs.size(1), self.h)
        ...
        pred_output = self.softmax(output_sum)
...
if __name__ == "__main__":
    ...
    # Please note that the file "word_embedding.pkl" is not included in this repository due to its large size.
